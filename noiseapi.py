...
if __name__ == "__main__":
    ...
    print("Done")
    reduce_noise_centroid_s(y, sr)
    print("Done")
    reduce_noise_centroid_mb(y, sr)
    print("Done")
    reduce_noise_mfcc_down(y, sr)
    print("Done")
    reduce_noise_mfcc_up(y, sr)
    print("Done")
    reduce_noise_median(y, sr)
    print("Done")
    trim_silence(y)
    print("Done")
    enhance(y)
    print("Done")
    output_file("C:\\Users\\user\\" ,filename, y, sr, ext="")
    print("Done")